...
#loading the images
opening = pg.image.load(r'C:\python\project\Tic Tac Toe\opening1.jpg')
x_img = pg.image.load(r'C:\python\project\Tic Tac Toe\x.png')
o_img = pg.image.load(r'C:\python\project\Tic Tac Toe\o.png')
