...
#win.configure(width=300, height=300, background='red') # size of app
#win.geometry('300x300') # size of app
# label = ttk.Label(win, text='Hello World')  # write something
# button = tk.Button(win, text='Hello')  # insert button
# button.pack()
# label.pack()
